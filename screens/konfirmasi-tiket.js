  ...
  return (
    <SafeAreaView style={styles.background}>
      <View style={styles.box}>
        ...
        <Text style={styles.heading}>Informasi Pemesanan</Text>
        ...
        <Text style={styles.subhead}>Nama Lengkap</Text>
        ...
        <Text style={styles.subhead}>Identitas</Text>
        <View style={styles.input}>
          <TextInput style={styles.TextInput} 
          placeholder="Laki">
          </TextInput>
        ...
        <Text style={styles.subhead}>Umur</Text>
        <View style={styles.input}>
          <TextInput style={styles.TextInput} 
          placeholder="Umur">
          </TextInput>
        ...
        <TouchableOpacity style={styles.tombol}>
          <Text style={styles.BuatTiket}>Submit</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  )
